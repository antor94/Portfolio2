  ...
  return (
    ...
    <section id='portfolio' className=''>
        <div className="container">
                <div className='flex justify-center'><CommonHead comh2={'My Working Portfolio'} /></div>
                        ...
                        <div className='w-[454px] h-[600px] bg-[#C4C4C4] m-[30px] flex justify-center'>
                            <div className='w-[394px] h-[120px] bg-white mt-[421px]'>
                                <div className='pt-[32px] pb-[34px] pl-[30px]'>
                                    <h2 className='text-[16px] font-semibold font-main text-primary'>UI/UX Design</h2>
                                    <h2 className='text-[24px] font-bold font-main text-main'>Daily Hydro-Drops</h2>
                                </div>
                            </div>
                        </div>
                    </div>
